...
1. Feature or improvement name
2. Description of the feature
3. The customer problem it solves
...
This prompt is used after customer insights have been identified (for example using response from Prompt 02 in this library) to generate potential feature ideas and product improvements.
...
This prompt helps automate the early ideation stage of product development by generating structured feature ideas based on customer insights. It can support product managers in quickly exploring possible improvements.
