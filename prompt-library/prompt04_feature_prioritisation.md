...
This prompt is used after feature ideas have been generated (for example using response from Prompt 03 in this library) to help product teams prioritise which features should be developed first.
...
This prompt helps product teams quickly evaluate feature ideas using a structured prioritisation framework, enabling faster decision-making and more efficient planning.
