...
This prompt is used after customer feedback has been analysed (for example response from Prompt 01 in this library) to summarise the key insights that product teams should consider when planning improvements or new features.
...
This prompt enables product teams to quickly transform analysed feedback into actionable insights that can support product planning and decision-making.
